  ...
  server.registerTool(
    "get_index",
    {
      ...
      description: [
        ...
        "- To see where MDS fits as a higher-level document scanner wrapper on top of DCV JS.",
        "",
        "WHEN NOT TO USE:",
        ...
        "",
        "RETURNS: A JSON object with top-level keys: productSelection and products. productSelection contains guidance for choosing between products (for example, DBR vs DCV), and products contains per-product entries (dcv, dbr, dwt, ddv, mds) with editions, platforms, latest versions, and counts of available docs and samples.",
        "",
        "PARAMETERS: None.",
        "",
        "EXAMPLE WORKFLOW:",
  ...
  server.registerTool(
    "search",
    {
      ...
      description: [
        ...
        "- product: dcv, dbr, dwt, ddv, or mds. Prefer DCV for lower-level capture-vision flows, DBR for barcode-only, and MDS for higher-level web document scanning.",
